...
const FIELD_LABELS: Record<string, string> = {
  ...
  personaKybStatus: 'Persona KYB status (passed / failed / pending)',
  personaKycStatuses: 'Persona KYC status per person',
  personaVerificationIssues: 'Persona verification issues / mismatches',
